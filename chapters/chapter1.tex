...
\begin{figure}[htbp]
    ...
    \caption{MIL, \acs{SIL}, PIL, \acs{HIL} and \acs{VIL} tests in the V-cycle development process~\cite{article}.}
    \label{fig:v_model}
\end{figure}
